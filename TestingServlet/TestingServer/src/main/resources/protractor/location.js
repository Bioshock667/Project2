describe("Location Settings tests", function(){
    ...
    it("should go to locations page", function(){
        element(by.css('[role="presentation"]')).click();
        browser.sleep(2000);
        element(by.xpath("/html/body/div/ui-view/nav/div/ul[2]/li[7]/ul/li[2]/a")).click();
        browser.sleep(3000);
