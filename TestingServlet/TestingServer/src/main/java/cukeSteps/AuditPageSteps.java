...
@Then("^after I move to home before going back to Quality Audit page$")
public void after_I_move_to_home_before_going_back_to_Quality_Audit_page() throws Throwable {
    driver.get("https://dev-caliber.revature.tech/caliber/#/vp/home");
    driver.get("https://dev-caliber.revature.tech/caliber/#/vp/audit");
}

@Then("^then go back to Week (\\d+), the Positive Symbol is highlighted And the overall feeback says \"([^\"]*)\"$")
public void then_go_back_to_Week_the_Positive_Symbol_is_highlighted_And_the_overall_feeback_says(int arg1, String arg2) throws Throwable {
    auditpage.getWeeks().get(arg1).click();
